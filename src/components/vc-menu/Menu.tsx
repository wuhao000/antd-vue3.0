...
const Menu: any = {
  ...
  render() {
    ...
    const subPopupMenuProps = {
      props: {
        ...props,
        itemIcon: getComponentFromProp(componentInstance, 'itemIcon', props),
        expandIcon: getComponentFromProp(componentInstance, 'expandIcon', props),
        overflowedIndicator: getComponentFromProp(componentInstance, 'overflowedIndicator', props) || (
          <span>···</span>
        ),
